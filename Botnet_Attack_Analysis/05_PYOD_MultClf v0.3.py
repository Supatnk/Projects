...
classifiers = {
                ...
                'AutoEncoder': AutoEncoder(epochs=30),
...
# 'AutoEncoder': AutoEncoder(epochs=30) 91 percent
# 'Stochastic Outlier Selection': SOS()
# 'Outlier Detection with Minimum Covariance Determinant uses Mahalanobis': MCD(),
# 'Average KNN Mahalanobis': KNN(n_neighbors=7, metric='mahalanobis',
#                                metric_params={'V': np.cov(data_scaled_train, rowvar=False)})
